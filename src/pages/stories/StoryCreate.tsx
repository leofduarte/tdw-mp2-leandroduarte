          ...
          <Card className="bg-transparent">
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label className="text-white" htmlFor="genres">
                    Genres *
                  </Label>
                  <Select
                    onValueChange={(value) => {
                ...
                <div className="space-y-2">
                  <Label className="text-white" htmlFor="targetAge">
                    Target Age *
                  </Label>
                  <Select
                    onValueChange={(value) =>
                ...
                <div className="space-y-2">
                  <Label className="text-white" htmlFor="contentWarnings">
                    Content Warnings
                  </Label>
                  <Select
                    onValueChange={(value) =>
                ...
                <div className="space-y-2 mt-2">
                  <Label className="text-white" htmlFor="initialSetup">
                    1st Chapter
                  </Label>
                  <Textarea
                    id="initialSetup"
